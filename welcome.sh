...
echo -e "${GRAY}  ───────────────────────────────────────────────────────────────────${NC}"
echo -e "  💡 Escribe ${YELLOW}ayuda${NC} (o ${YELLOW}vibe-help${NC}) para ver la guía completa de atajos"
echo -e "  ✅ Escribe ${YELLOW}verify${NC} (o ${YELLOW}vibe-verify${NC}) para comprobar las 13 herramientas"
echo ""
